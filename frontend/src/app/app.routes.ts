...
export const routes: Routes = [
	...
	{ path: 'tratamiento-datos', loadComponent: () => import('./pages/tratamiento-datos/tratamiento-datos-page.component').then((m) => m.TratamientoDatosPageComponent) },
	{ path: 'politica-envio', loadComponent: () => import('./pages/politica-envio/politica-envio-page.component').then((m) => m.PoliticaEnvioPageComponent) },
